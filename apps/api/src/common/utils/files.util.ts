...
//     const envFilePath: string = resolve(
//       projectRoot,
...
//         `Environment File(s) Not found at : ${envDefault} and / or ${envFilePath}`,
...
//     filePath: string,
//   ): Promise<{ created: boolean; dirname: string }> {
