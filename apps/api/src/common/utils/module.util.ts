...
//   // private static envFiles: string[] = process.env.NODE_ENV === 'development' ? ['.env.development', '.env'] : ['.env.test', '.env'];
//   // private static runEnv = `${process.env.NODE_ENV || 'production'}`;
//   // private static envFiles: string[] = ModuleUtil.runEnv === 'development' ? ['development.env'] : ModuleUtil.runEnv === 'test' ? ['test.env'] : ['production.env'];
